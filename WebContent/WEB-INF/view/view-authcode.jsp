...
<title>View Authcode List</title>
</head>
    ...
    <div class="container-fluid">
      <div class="row">
        <div class="col-sm-3 col-md-2 sidebar">
          ...
          <ul class="nav nav-sidebar">
            ...
            <h4 class="nav nav-sidebar">Miscellaneous</h4>
            	<ul class="nav nav-sidebar">
            	<li><a href="viewProfile">View Profile List</a></li>
            	<li class="active"><a href="viewAuthcode">View Authcode List</a></li>
            	</ul>
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          <h1 class="page-header">Mainframe Authcode List</h1>
